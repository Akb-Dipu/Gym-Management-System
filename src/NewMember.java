...
public class NewMember extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "6.00-12.00am", "12.00-4.30(Ladies time)", "4.30-10.00pm" }));
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/arnold.jpg"))); // NOI18N
       ...
       String gender=(String)jComboBox1.getSelectedItem();
        String gymtime=(String)jComboBox2.getSelectedItem();
         ...
         String age=jTextField7.getText(); 
          ...
          String regid=jTextField5.getText();
          
           String amount=jTextField8.getText();
            String address=jTextField2.getText();
         try {
            Connection con=ConnectionProvider.getCon();
          PreparedStatement ps = con.prepareStatement("INSERT INTO member (id, name, mobilenumber, email, gender, gymtime, age, regid, amount, address) VALUES (?,?,?,?,?,?,?,?,?,?)");
          ps.setString(1,id);
          ps.setString(2,name);
